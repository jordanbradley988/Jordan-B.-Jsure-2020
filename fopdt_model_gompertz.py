# -*- coding: utf-8 -*-
"""
Created on Sat Jul  4 17:57:04 2020
...
def fopdt(y,t,Km,taum,thetam):
 ...
 #       else:
  ...
  #      um = 0
    ...
    dydt = Km*y*(np.log(taum/y+thetam))           # (-(y-yp0))*Km # + Km * (um-u0))/taum
    return dydt
...
def sim_model(x):
  ...
  #              y1 = odeint(fopdt,ym[i],ts,args=(uf,Km,taum,thetam))
        y1 = odeint(fopdt,ym[i],ts,args=(Km,taum,thetam,))
        ym[i+1] = y1[-1]
    return ym
